...
sleep 1
clear
wget https://raw.githubusercontent.com/zuzuq/ss/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
wget https://raw.githubusercontent.com/zuzuq/ss/main/Sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/zuzuq/ss/main/udp/udp.sh && chmod +x udp.sh && ./udp.sh
clear
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Created By HITS SSH ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
rm /root/setup.sh >/dev/null 2>&1
